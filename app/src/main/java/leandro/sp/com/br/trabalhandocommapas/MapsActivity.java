...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener {
    ...
    //Trecho específicamente relacionado ao sensor GPS
    ...
    @Override
    public void onLocationChanged(Location location) { //método da interface LocationListener que serve para monitorar as alterações de localização pelo GPS
    ...
    //Fim Trecho específicamente relacionado ao sensor GPS
}
